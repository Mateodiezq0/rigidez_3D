...
nodo_j = Nodo(id=2, x=100, y=0, z=0, restricciones = [True,True,True,True,True,True])
nodo_k = Nodo(id=3, x=100, y=100, z=0, restricciones = [True,True,True,True,True,True])
...
barra2 = Barra(
    id=2, nodo_i=2, nodo_f=3, E=30000, I_y=100, I_z=100, G=10000, J=50,
